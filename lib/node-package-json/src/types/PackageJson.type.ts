...
import type { PackageJsonPerson, PackageJsonPersonSingleLine } from './PackageJsonPerson.type';
import type { SPDXLicenseExpression } from '@wonderful-tools/util-spdx';
...
export interface PackageJson {
   ...
   * If you don't plan to publish your package, the name and version fields are optional.
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#version
   */
  version?: string;
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#description-1
   */
  description?: string;
   ...
   * This helps people discover your package as it's listed in npm search.
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#keywords
   */
  keywords?: string[];
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#homepage
   */
  homepage?: string;
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#bugs
   */
  bugs?: {
    /**
     * ### Bug report URL
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#license
   */
  license?:
    | SPDXLicenseExpression // Single or Multiple licenses
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#funding
   */
  funding?: (
    | {
        /**
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#files
   */
  files?: string[];
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#main
   */
  main?: string;
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#browser
   */
  browser?: string;
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#repository
   */
  repository?:
    | {
        /**
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#scripts
   */
  scripts?: {
    [key: string]: string;
  };
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#devdependencies
   */
  devDependencies?: {
    [key: string]: Dependency;
  };
   ...
   *
   * @reference https://docs.npmjs.com/cli/v7/configuring-npm/package-json#peerdependencies
   */
  peerDependencies?: {
    [key: string]: Dependency;
  };
